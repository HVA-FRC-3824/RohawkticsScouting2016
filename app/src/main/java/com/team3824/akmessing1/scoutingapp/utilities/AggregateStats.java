    ...
    public static void updateTeam(int team, MatchScoutDB matchScoutDB, SuperScoutDB superScoutDB,
        ...
        for (teamInfo.moveToFirst(); !teamInfo.isAfterLast(); teamInfo.moveToNext()) {
            ...
            if (superMatch != null) {
                ...
                defense3 = superMatch.getString(Constants.DEFENSE_3).toLowerCase().replace(" ", "_");
        ...
        for (int j = 0; j < 9; j++) {
            newTeamStats.put(Constants.TOTAL_DEFENSES_STARTED[j], totalStartPosition[j]);
            newTeamStats.put(Constants.TOTAL_DEFENSES_SEEN[j], totalDefensesSeen[j]);
            newTeamStats.put(Constants.TOTAL_DEFENSES_AUTO_REACHED[j], totalDefenseReaches[j]);
            newTeamStats.put(Constants.TOTAL_DEFENSES_AUTO_CROSSED[j], totalDefenseCrosses[j]);
            newTeamStats.put(Constants.TOTAL_DEFENSES_TELEOP_CROSSED[j], totalTeleopDefenses[j]);
            newTeamStats.put(Constants.TOTAL_DEFENSES_TELEOP_NOT_CROSSED[j], totalTeleopNotCross[j]);
            newTeamStats.put(Constants.TOTAL_DEFENSES_TELEOP_CROSSED_POINTS[j], totalTeleopDefensesPoints[j]);
            newTeamStats.put(Constants.TOTAL_DEFENSES_TELEOP_TIME[j], totalDefensesTime[j]);
        }
        newTeamStats.put(Constants.TOTAL_DEFENSES_STARTED[9], totalStartPosition[9]);
        newTeamStats.put(Constants.TOTAL_DEFENSES_STARTED[10], totalStartPosition[10]);

        newTeamStats.put(Constants.TOTAL_AUTO_HIGH_HIT, totalAutoHighGoalHit);
        newTeamStats.put(Constants.TOTAL_AUTO_HIGH_MISS, totalAutoHighGoalMiss);
        newTeamStats.put(Constants.TOTAL_AUTO_LOW_HIT, totalAutoLowGoalHit);
        newTeamStats.put(Constants.TOTAL_AUTO_LOW_MISS, totalAutoLowGoalMiss);

        newTeamStats.put(Constants.TOTAL_TELEOP_HIGH_HIT, totalTeleopHighGoalHit);
        newTeamStats.put(Constants.TOTAL_TELEOP_HIGH_MISS, totalTeleopHighGoalMiss);
        newTeamStats.put(Constants.TOTAL_TELEOP_LOW_HIT, totalTeleopLowGoalHit);
        newTeamStats.put(Constants.TOTAL_TELEOP_LOW_MISS, totalTeleopLowGoalMiss);

        newTeamStats.put(Constants.TOTAL_CHALLENGE, totalChallenge);
        newTeamStats.put(Constants.TOTAL_SCALE, totalScale);

        newTeamStats.put(Constants.TOTAL_DQ, totalDQ);
        newTeamStats.put(Constants.TOTAL_STOPPED, totalStopped);
        newTeamStats.put(Constants.TOTAL_DIDNT_SHOW_UP, totalDidntShowUp);

        newTeamStats.put(Constants.TOTAL_FOULS, totalFouls);
        newTeamStats.put(Constants.TOTAL_TECH_FOULS, totalTechFouls);
        newTeamStats.put(Constants.TOTAL_YELLOW_CARDS, totalYellowCards);
        newTeamStats.put(Constants.TOTAL_RED_CARDS, totalRedCards);

        newTeamStats.put(Constants.TOTAL_MATCHES, totalMatches);
