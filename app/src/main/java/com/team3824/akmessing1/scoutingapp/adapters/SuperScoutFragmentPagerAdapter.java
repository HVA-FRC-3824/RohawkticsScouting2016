...
public class SuperScoutFragmentPagerAdapter extends FragmentPagerAdapter{
    ...
    public SuperScoutFragmentPagerAdapter(FragmentManager fm, ArrayList<Integer> teams) {
        super(fm);
        this.teams = teams;
    }
