...
public class ELA_Points extends ArrayAdapter<ELI_Points> {
    ...
    private final String TAG = "ELA_Points";

    private ArrayList<ELI_Points> mTeams;

    /**
     * @param context
     * @param teams
     */
    public ELA_Points(Context context, ArrayList<ELI_Points> teams) {
        super(context, R.layout.list_item_event_points, teams);
        mTeams = teams;
    }
